...
(function() {
  $(document).on('turbolinks:load', function() {
    ...
    $('.call').on('click', function() {
      return $('.establishment_icons_background, .telephone').show(500);
    });
    $('.place').on('click', function() {
      return $('.establishment_icons_background, .address').show(500);
    });
    $('.star').on('click', function() {
      return $('.establishment_icons_background, .rating').show(500);
    });
    $('.world').on('click', function() {
      return $('.establishment_icons_background, .social').show(500);
    });
    return $('.close').on('click', function() {
      return $('.establishment_icons_background, .telephone, .address, .social, .rating').hide(500);
    });
  });
